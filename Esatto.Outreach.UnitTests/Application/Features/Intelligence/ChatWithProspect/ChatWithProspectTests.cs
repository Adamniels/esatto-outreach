...
namespace Esatto.Outreach.UnitTests.Application.Features.Intelligence.ChatWithProspect;
...
public class ChatWithProspectTests
{
    ...
    public async Task Handle_WhenUserIsOwner_InvokesAiAndReturnsResponse()
    {
        ...
        var expectedResponse = new ChatWithProspectResponse("Here is my answer", false, null, null, null);
