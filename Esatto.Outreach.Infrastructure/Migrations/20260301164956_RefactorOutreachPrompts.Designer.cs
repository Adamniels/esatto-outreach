...
namespace Esatto.Outreach.Infrastructure.Migrations
{
    ...
    [Migration("20260301164956_RefactorOutreachPrompts")]
    partial class RefactorOutreachPrompts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Esatto.Outreach.Domain.Entities.WorkflowInstance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Esatto.Outreach.Domain.Entities.WorkflowStep", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Esatto.Outreach.Domain.Entities.WorkflowTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Esatto.Outreach.Domain.Entities.WorkflowTemplateStep", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Esatto.Outreach.Domain.Entities.WorkflowStep", b =>
                {
                    b.HasOne("Esatto.Outreach.Domain.Entities.WorkflowInstance", "WorkflowInstance")
                        .WithMany("Steps")
            ...
            modelBuilder.Entity("Esatto.Outreach.Domain.Entities.WorkflowTemplateStep", b =>
                {
                    b.HasOne("Esatto.Outreach.Domain.Entities.WorkflowTemplate", null)
                        .WithMany("Steps")
