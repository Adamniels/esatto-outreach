...
/// <summary>
/// OpenAI implementation of research service using Responses API with web search.
/// </summary>
public sealed class OpenAIResearchService : IResearchService
{
    ...
    public OpenAIResearchService(HttpClient http, IOptions<OpenAiOptions> options)
    {
        _http = http;
