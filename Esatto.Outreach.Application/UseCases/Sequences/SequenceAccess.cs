...
/// </summary>
public sealed class SequenceAccess
{
    private readonly ISequenceRepository _repo;

    public SequenceAccess(ISequenceRepository repo)
    {
        _repo = repo;
    }
    ...
    /// <summary>For read-only access (e.g. GetSequence) — same ownership semantics, different message.</summary>
